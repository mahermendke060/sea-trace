    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage downstream customers</p>
        </div>
        <Button onClick={() => { setSelectedCustomer(null); setDialogOpen(true); }} className="gap-2 bg-emerald-600 hover:bg-emerald-700">
